...
function us_script() {
  ...
  wp_enqueue_style( 'grid', plugins_url('/assets/simplegrid.css', __FILE__), array(), null, 'all' );

  wp_enqueue_script( 'us_script_js', plugins_url('/assets/us-admin.js', __FILE__), array('jquery'), '20120206', true );
}
